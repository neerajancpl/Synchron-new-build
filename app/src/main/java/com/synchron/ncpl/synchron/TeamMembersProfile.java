...
public class TeamMembersProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_members_profile);
    ...
    loadUrl("http://www.synchron.6elements.net/webservices/get_teammember.php?user_id=" + userId + "");
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        Glide.with(TeamMembersProfile.this).load(aImage).into(profile);
